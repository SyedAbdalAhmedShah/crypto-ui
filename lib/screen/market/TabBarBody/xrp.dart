...
import 'package:crypto_v2_null_safety/screen/market/detailCrypto/xrpDetail.dart';
...
class _xrpState extends State<xrp> {
  ...
  var imageNetwork = NetworkImage(
      "https://firebasestorage.googleapis.com/v0/b/beauty-look.appspot.com/o/Screen5.png?alt=media&token=03975ced-fdb2-43b6-af3a-2e48e05288b8");
        ...
        InkWell(
          onTap: () {
            Navigator.of(ctx).push(PageRouteBuilder(
                pageBuilder: (_, __, ___) => new xrpDetail(item: item)));
          },
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            crossAxisAlignment: CrossAxisAlignment.center,
