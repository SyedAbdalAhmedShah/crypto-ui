...
import 'package:crypto_v2_null_safety/screen/market/detailCrypto/usdtDetail.dart';
...
class _usdtState extends State<usdt> {
  ...
  var imageNetwork = NetworkImage(
      "https://firebasestorage.googleapis.com/v0/b/beauty-look.appspot.com/o/Screen2.png?alt=media&token=0d7fbd84-418b-4a6d-a6cb-e2f36dea78e6");
        ...
        InkWell(
          onTap: () {
            Navigator.of(ctx).push(PageRouteBuilder(
                pageBuilder: (_, __, ___) => new usdtDetail(item: item)));
          },
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            crossAxisAlignment: CrossAxisAlignment.center,
