import 'package:crypto_v2_null_safety/component/loserModel.dart';
...
class loserDetail extends StatefulWidget {
  ...
  loserDetail({Key? key, this.item}) : super(key: key);

  _loserDetailState createState() => _loserDetailState(item: item);
}

class _loserDetailState extends State<loserDetail> {
  losers? item;
                    ...
                    children: <Widget>[
                      Expanded(
                        child: DefaultTabController(
                          ...
                          child: new Scaffold(
                            appBar:
                                _tabBarCustomButton() as PreferredSizeWidget?,
                            body: Padding(
